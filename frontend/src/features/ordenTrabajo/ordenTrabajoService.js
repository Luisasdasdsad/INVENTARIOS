...
export const ordenTrabajoService = {
  ...
  crearDesdeCotizacion: async (cotizacionId, tecnicoId, observaciones, fechaInicio, fechaFin, instruccionesTecnico, descripcionServicio) => {
    const response = await api.post("/ordenes-trabajo/desde-cotizacion", {
      ...
      descripcionServicio // 💡 Añadido el campo que faltaba
    });
    return response.data;
  },
